...
public class ConnectAPI {
	...
	public static int UPDATE_GLOBAL_DATA_RESPONSE = 0x000108;
	public static int UPDATE_ROOMCARD_REQUEST = 0x000109;
	...
	// buhua
	public static int BUHUA_RESPONSE = 0x100021;
	public static int BUHUA_REQUEST = 0x100022;
	public static int HUAGANG_RESPONSE = 0x100023;
	public static int BUHUA_BEGIN_RESPONSE = 0x100025;

	// notice score
	public static int SCORE_RESPONSE = 0x100024;
	...
	public static int TIME_WAIT_RESPONSE = 0x009999;
	public static int MSG_LOCATION = 0x005842;
